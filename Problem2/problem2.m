...
A1 = [[1 delta_t 0 0];[0 1 -delta_t*K_2 0];[0 0 1 delta_t];
...
x0_zdim = [x0; zeros(N*mx+M*mu-size(x0,1),1)];
Aeq = gen_aeq(A1,B1,N,mx,mu);             % Generate A, hint: gen_aeq
%beq = Aeq*x0_zdim;                        % Generate b
beq = zeros(N*mx,1);
value = A1*x0;
beq(1) = value(1);
...
%saveas(gcf, '10_2_3 Q=(0_0_0_1)','png');
%saveas(gcf, '10_2_3 Q=(0_0_0_1)','eps');