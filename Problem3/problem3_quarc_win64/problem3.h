 ...
 */
#ifndef RTW_HEADER_problem3_h_
#define RTW_HEADER_problem3_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef problem3_COMMON_INCLUDES_
# define problem3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* problem3_COMMON_INCLUDES_ */

#include "problem3_types.h"
...
#define problem3_rtModel               RT_MODEL_problem3_T
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace3_PWORK;              /* '<S8>/From Workspace3' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace4_PWORK;              /* '<S8>/From Workspace4' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace3_IWORK;              /* '<S8>/From Workspace3' */

  struct {
    int_T PrevIndex;
  } FromWorkspace4_IWORK;              /* '<S8>/From Workspace4' */
...
#define rtB                            problem3_B
#define BlockIO                        B_problem3_T
#define rtX                            problem3_X
#define ContinuousStates               X_problem3_T
#define rtXdot                         problem3_XDot
#define StateDerivatives               XDot_problem3_T
#define tXdis                          problem3_XDis
#define StateDisabled                  XDis_problem3_T
#define rtP                            problem3_P
#define Parameters                     P_problem3_T
#define rtDWork                        problem3_DW
#define D_Work                         DW_problem3_T

/* Parameters (auto storage) */
struct P_problem3_T_ {
...
extern P_problem3_T problem3_P;

/* Block signals (auto storage) */
extern B_problem3_T problem3_B;

/* Continuous states (auto storage) */
extern X_problem3_T problem3_X;

/* Block states (auto storage) */
extern DW_problem3_T problem3_DW;

/* Model entry point functions */
extern void problem3_initialize(void);
extern void problem3_output(void);
extern void problem3_update(void);
extern void problem3_terminate(void);

/* Real-time Model object */
extern RT_MODEL_problem3_T *const problem3_M;
 ...
 *
 * '<Root>' : 'problem3'
 * '<S1>'   : 'problem3/Conversion'
 * '<S2>'   : 'problem3/Degrees to Radians'
 * '<S3>'   : 'problem3/Degrees to Radians1'
 * '<S4>'   : 'problem3/Degrees to Radians2'
 * '<S5>'   : 'problem3/Degrees to Radians3'
 * '<S6>'   : 'problem3/Elevation controller'
 * '<S7>'   : 'problem3/Helicopter_interface'
 * '<S8>'   : 'problem3/LQ controller'
 * '<S9>'   : 'problem3/Pitch controller'
 * '<S10>'  : 'problem3/Helicopter_interface/Elevation rad to deg'
 * '<S11>'  : 'problem3/Helicopter_interface/Elevation rate rad to deg'
 * '<S12>'  : 'problem3/Helicopter_interface/Pitch rad to deg'
 * '<S13>'  : 'problem3/Helicopter_interface/Pitch rate rad to deg'
 * '<S14>'  : 'problem3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S15>'  : 'problem3/Helicopter_interface/Travel rad to deg'
 * '<S16>'  : 'problem3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_problem3_h_ */
